...
from mani_skill.agents.robots import Stompy, Fetch, Panda, Xmate3Robotiq
...
class PickCubeEnv(BaseEnv):
    SUPPORTED_ROBOTS = ["stompy", "panda", "xmate3_robotiq", "fetch"]
    agent: Union[Stompy, Panda, Xmate3Robotiq, Fetch]
    cube_half_size = 0.02
    goal_thresh = 0.025
